...
const FutureTogether: React.FC<FutureTogetherProps> = ({ className }) => {
  ...
  const [dreams, setDreams] = useState<DreamItem[]>([
    {
      ...
      title: "Go to a Beach",
      description:
        "Spend a romantic weekend at a Beach, swim thorugh the tides and have a dinner along the shore.",
      category: "travel",
      icon: "map-pin",
    },
    {
      ...
      description:
        "Go out for shopping for the entire day coz that's what you love the most",
      category: "adventure",
      icon: "rocket",
    },
    {
      ...
      description:
        "Celebrate our graduation and the beginning of career journey.",
      category: "milestone",
      icon: "calendar",
    },
    {
      id: "4",
      title: "A Temple",
      description: "Go to a mandir because you always wanted to.",
      category: "travel",
      icon: "map-pin",
    },
    {
      ...
      title: "Cooking Class",
      description:
        "Take a cooking class to learn how to make authentic Italian pasta from scratch.",
      category: "adventure",
      icon: "rocket",
    },
    {
      id: "6",
      title: "Much more years together",
      description: "Celebrate your birthday every year with love and joy.",
      category: "milestone",
      icon: "calendar",
    },
  ]);
  ...
  const adventureDreams = dreams.filter(
    (dream) => dream.category === "adventure"
  );
  const milestoneDreams = dreams.filter(
    (dream) => dream.category === "milestone"
  );
  ...
  return (
    <div className={cn("max-w-6xl mx-auto px-4", className)}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-gradient-to-br from-white to-birthday-lavender/20 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-script text-birthday-purple">
              Places We'll Visit
            </h3>
          </div>
              ...
              >
                ...
                <CollapsibleContent className="p-3 text-gray-600 bg-white/80 rounded-b-lg border-t border-gray-100">
                  <textarea
                    ...
                    rows={3}
                    onChange={(e) =>
                      updateDreamDescription(dream.id, e.target.value)
                    }
        ...
        <div className="bg-gradient-to-br from-white to-birthday-pink/20 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-script text-birthday-rose">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-10">
        <h3 className="text-xl font-script text-birthday-rose mb-4">
          Add Your Own Dreams
        </h3>
      ...
      <div className="relative p-6 rounded-lg overflow-hidden bg-gradient-to-br from-birthday-lavender/20 via-white to-birthday-pink/20 shadow-lg">
        <h3 className="text-2xl font-script text-center text-birthday-purple mb-6">
          Our Dream Map
        </h3>
          ...
          {dreams.map((dream) => (
            ...
            >
              <div
                className={cn(
                  ...
                  dream.category === "travel"
                    ? "bg-gradient-to-br from-birthday-lavender/50 to-birthday-lavender/20"
                    : dream.category === "adventure"
                    ? "bg-gradient-to-br from-birthday-rose/50 to-birthday-pink/20"
              ...
              >
                ...
                <p className="text-sm text-center font-medium text-black/80 drop-shadow-md">
                  {dream.title}
                </p>
              </div>
