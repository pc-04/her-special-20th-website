...
const BirthdayPhotoFrame: React.FC<BirthdayPhotoFrameProps> = ({ className }) => {
  return (
    <div className={cn("relative text-center py-10", className)}>
      <div className="relative mx-auto max-w-2xl">
        {/* Photo frame with placeholder */}
        <div className="relative border-8 border-birthday-lavender rounded-lg shadow-xl overflow-hidden 
          ...
          <div className="w-full h-full overflow-hidden rounded-sm bg-birthday-lavender/20">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/30 text-white">
              <p className="text-lg font-medium">Add her favorite photo here</p>
            </div>
          </div>
        ...
        {[...Array(8)].map((_, i) => (
          <Heart 
            ...
            style={{
              ...
              color: i % 2 === 0 ? 'var(--birthday-rose-color, #FF69B4)' : 'var(--birthday-pink-color, #FFB6C1)',
